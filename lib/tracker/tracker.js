...
function File() {
	...
	var peer1 = new Peer('10.0.1.160', '32772', '0');
	this.insertPeer(peer1);
	var peer2 = new Peer('127.0.0.1', '51413', '1074692');
...
*/
	...
	insertPeer: function(peer) {
		...
		var i = 0;
		for (var prop in this.peerDict) {
			console.log(this.peerDict[prop]);
			// if (!this.peerDict.hasOwnProperty(p))
			// 	continue;
